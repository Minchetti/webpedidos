...
<div id="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                    <i class="fa fa-clone" aria-hidden="true"></i> Criar Template
                </h1>
            </div>
        </div>
        <!-- /.row -->
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    <label>Nome<span style="color: red;">*</span> <small style="color:rgb(159, 159, 160); font-size: 0.82em;">Caracteres(<span id="txtDescricao-caracter">0</span>/50)</small></label>
                    <input id="txtTemplateDescricao" type="text" class="form-control" name="template-descricao" placeholder="Nome" maxlength="50" style="text-transform: uppercase;"/>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group">
                    <label>Setor IO<span style="color: red;">*</span></label>
                    <input id="txtSetor" type="text" class="form-control" name="template-setor" placeholder="Setor" style="text-transform: uppercase;"/>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group">
                    <label>Observação2 <small style="color:rgb(159, 159, 160); font-size: 0.82em;">Caracteres (<span id="txtObservacaoCaracter">0</span>/150)</small></label>
                    <textarea id="txtObservacaoTemplate" class="form-control" name="observacao-template" placeholder="Observação2" maxlength="150" style="text-transform: uppercase; resize: none;"></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <table id="funcionarios-lista" class="table table-hover table-bordered table-striped">
                    ...
                    <tbody id="lista-funcionarios-setor"></tbody>
                </table>
            </div>
        </div>
        <!-- //Selecionar funcionários -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <button id="btn-confirmar-selecionados" class="btn btn-primary pull-right" style="display: none;"><i class="fa fa-check-square-o" aria-hidden="true"></i> Confirmar selecionados</button>
            </div>
            <hr />
        </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-list" aria-hidden="true"></i> Lista de produtosXX</h4>
      </div>
